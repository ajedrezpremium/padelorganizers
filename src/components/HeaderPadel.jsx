...
const TOOLTIPS = {
    ...
    fr: { home: 'Accueil', launch: 'Lancement et offres', demo: 'Essayer la démo gratuite', dashboard: 'Tableau des pistes', live: 'Vue en direct', livepro: 'LiveScore Pro', club: 'Réserver une piste', tournament: 'Tournoi', analytics: 'Analyses du tournoi', league: 'Ligue classée', directory: 'Annuaire des clubs et écoles', shop: 'Boutique', members: 'Membres & abonnements', control: 'Centre de contrôle du tournoi' },
    pt: { home: 'Início', launch: 'Lançamento e ofertas', demo: 'Experimentar a demo grátis', dashboard: 'Dashboard de pistas', live: 'Vista ao vivo', livepro: 'LiveScore Pro', club: 'Reservar pista no clube', tournament: 'Torneio', analytics: 'Análises do torneio', league: 'Liga ranqueada', directory: 'Diretório de clubes e escolas', shop: 'Loja', members: 'Sócios & assinaturas', control: 'Central de controle do torneio' },
  };
