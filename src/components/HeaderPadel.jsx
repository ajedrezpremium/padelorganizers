...
<nav style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
        ...
        <Link to="/socio" data-tooltip={t.membercard} aria-label={t.membercard} className="nav-ico" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '9px 11px', color: '#60a5fa', textDecoration: 'none' }}>
          <NavIcon name="membercard" />
        </Link>
        <Link to="/alumno" data-tooltip={t.student} aria-label={t.student} className="nav-ico" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '9px 11px', color: '#f472b6', textDecoration: 'none' }}>
          <NavIcon name="student" />
        </Link>
