...
const I18N = {
  ...
  fr: {
    pending: 'Demander la vérification',
    confirm: 'Vérifier la fiche',
    hPending: 'Demander la vérification de votre fiche',
    hConfirm: 'Vérifier la fiche de votre club',
    intro: 'Complétez vos coordonnées. Un membre de notre équipe examinera votre demande et vous enverra le lien de confirmation.',
    introConfirm: 'Vos données seront publiées dans l’annuaire avec le badge « Vérifié » et vous apparaîtrez plus haut dans les recherches.',
    clubLabel: 'Club',
    stateLabel: 'Statut',
    name: 'Votre nom',
    email: 'Votre e-mail',
    ...
    sendConfirm: 'Confirmer et vérifier',
    back: '← Retour à l’annuaire',
    successPending: 'Demande envoyée. Nous examinerons vos données et vous enverrons le lien de confirmation.',
    successConfirm: 'Fiche vérifiée ! Merci d’avoir confirmé les données de votre club.',
    invalid: 'Ce lien est invalide ou le jeton ne correspond pas.',
    loading: 'Chargement de la fiche…',
    saveError: 'Impossible d’envoyer. Vérifiez que le formulaire est complet.',
    verificado: 'Vérifié',
    pendiente: 'En attente de vérification',
    notFound: 'Club introuvable.',
    off: 'La vérification par e-mail est disponible lorsque la plateforme est connectée au cloud.',
  },
  pt: {
    pending: 'Solicitar verificação',
    confirm: 'Verificar ficha',
    hPending: 'Solicitar verificação da sua ficha',
    hConfirm: 'Verificar a ficha do seu clube',
    intro: 'Preencha os seus dados de contato. Um membro da nossa equipa analisará o seu pedido e enviará o link de confirmação.',
    introConfirm: 'Os seus dados serão publicados no diretório com o selo "Verificado" e aparecerão mais acima nas pesquisas.',
    clubLabel: 'Clube',
    stateLabel: 'Estado',
    name: 'O seu nome',
    email: 'O seu e-mail',
    ...
    notes: 'Notas (opcional)',
    send: 'Enviar pedido',
    sendConfirm: 'Confirmar e verificar',
    back: '← Voltar ao diretório',
    successPending: 'Pedido enviado. Analisaremos os seus dados e enviaremos o link de confirmação.',
    successConfirm: 'Ficha verificada! Obrigado por confirmar os dados do seu clube.',
    invalid: 'Este link é inválido ou o token não corresponde.',
    loading: 'A carregar ficha…',
    saveError: 'Não foi possível enviar. Verifique se o formulário está completo.',
    verificado: 'Verificado',
    pendiente: 'Pendente de verificação',
    notFound: 'Clube não encontrado.',
    off: 'A verificação por e-mail está disponível quando a plataforma está ligada à nuvem.',
  },
};
