...
const LEGENDS = [
  { num: 1, name: 'Fernando Belasteguín', flag: '🇦🇷', elo: 2985, era: '2002-2024', country: 'Argentina', deed: '1 (Bela)', title: '17 años nº1 del mundo', bio: 'El jugador más dominante de la historia. 17 temporadas consecutivas al frente del ranking mundial y 16 campeonatos con Juan Martín Díaz.' },
  { num: 2, name: 'Juan Martín Díaz', flag: '🇦🇷', elo: 2960, era: '2002-2017', country: 'Argentina', deed: '1 (Bela)', title: 'La pareja más laureada', bio: 'Leyenda absoluta: 266 títulos y 16 años al máximo nivel junto a Belasteguín, la mejor dupla que ha dado el pádel.' },
  { num: 3, name: 'Alejandro Galán', flag: '🇪🇸', elo: 2940, era: '2020-2026', country: 'España', deed: '1', title: 'El nº1 de la era moderna', bio: 'Referente actual. Número 1 del mundo reinando por temporadas con Lebrón antes de la era de los "chicos".' },
  { num: 4, name: 'Juan Lebrón', flag: '🇪🇸', elo: 2930, era: '2020-2026', country: 'España', deed: '1', title: 'El martillo de El Puerto', bio: 'Número 1 del mundo y campeón del World Padel Tour con Galán. Potencia brutal y un revés letal.' },
  { num: 5, name: 'Pablo Lima', flag: '🇧🇷', elo: 2915, era: '2004-2020', country: 'Brasil', deed: '1', title: 'El mejor brasileño de la historia', bio: 'Ocupó el nº1 mundial y formó pareja legendaria con Belasteguín tras la era de J.M. Díaz. Podio constante 15 años.' },
  ...
  { num: 7, name: 'Agustín Tapia', flag: '🇦🇷', elo: 2880, era: '2021-2026', country: 'Argentina', deed: '1', title: 'La zurda de oro', bio: 'Virtuoso técnico con una zurda histórica. Reinó como nº1 con Coello al pulso de la era de máxima velocidad.' },
  { num: 8, name: 'Arturo Coello', flag: '🇪🇸', elo: 2870, era: '2022-2026', country: 'España', deed: '1', title: 'El jugador total', bio: 'Formidable en todos los golpes. Comparte trono mundial con Tapia domando la nueva generación de torneos.' },
  { num: 9, name: 'Sanyo Gutiérrez', flag: '🇦🇷', elo: 2850, era: '2012-2024', country: 'Argentina', deed: '1', title: 'La magia de Arroyo Seco', bio: 'Número 1 del mundo y el jugador más completo del circuito por lectura. Con Paquito o Tapia, siempre en la élite.' },
  { num: 10, name: 'Franco Stupaczuk', flag: '🇦🇷', elo: 2830, era: '2016-2026', country: 'Argentina', deed: '2', title: 'El todoterreno', bio: 'De la cuna argentina al top mundial. Poder físico y golpeo imponente durante más de una década.' },
  { num: 11, name: 'Martín Di Nenno', flag: '🇦🇷', elo: 2810, era: '2016-2026', country: 'Argentina', deed: '2', title: 'El cañonero', bio: 'El pegador más temido de sus generación. Subcampeón del mundo y referente eterno del revés plano.' },
