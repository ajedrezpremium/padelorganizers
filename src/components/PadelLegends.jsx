...
const LEGENDS = [
  ...
  { num: 6, name: 'Paquito Navarro', flag: '🇪🇸', elo: 2890, era: '2012-2024', country: 'España', deed: '2', title: 'El fenómeno mediático', bio: 'El jugador con más carisma del circuito. Top-3 mundial, especialista en bandejas imposibles y claves en pantalla.', photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Paquito_Navarro.jpg/330px-Paquito_Navarro.jpg' },
  ...
  { num: 21, name: 'Gemma Triay', flag: '🇪🇸', elo: 2630, era: '2018-2026', country: 'España', deed: '1', title: 'La reina femenina', bio: 'Número 1 femenino durante temporadas con Alejandra Salazar primero y su reinado con Claudia Fernández.', photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Dis12.jpg/330px-Dis12.jpg' },
  ...
  { num: 23, name: 'Bea González', flag: '🇪🇸', elo: 2610, era: '2019-2026', country: 'España', deed: '1', title: 'La zurda prodigio', bio: 'La joya de la nueva generación femenina. Junto a Martita alcanzó la cima del ranking mundial.', photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Beagonzalezjuly2013.jpg/330px-Beagonzalezjuly2013.jpg' },
  { num: 24, name: 'Alejandra Salazar', flag: '🇪🇸', elo: 2600, era: '2013-2024', country: 'España', deed: '1', title: 'La leyenda madrileña', bio: 'Número 1 femenino, ganadora en más de 50 torneos grandes y referente total del pádel femenino español.', photo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Alejandra_Salazar.jpg/330px-Alejandra_Salazar.jpg' },
