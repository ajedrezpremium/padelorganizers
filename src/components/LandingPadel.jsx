...
const I18N = {
  es: {
    ...
    comparison: [
      ...
      ['Pago dividido por jugador (splits)', '✓', '✓', 'Parcial', '✓', '✗'],
      ...
      ['Yield management (precios dinámicos)', '✓', 'Parcial', 'Parcial', '✗', '✗'],
      ['IoT: luces por QR + ahorro energía', '✓', '✗', '✓', '✗', '✗'],
      ['ERP escuela + cobro recurrente', '✓', '✓', '✓', '✗', '✗'],
      ['Carnet + ficha pública del jugador', '✓', 'Parcial', '✗', 'Parcial', '✗'],
      ['Dashboard de negocio (KPIs)', '✓', '✓', '✓', '✗', 'Parcial'],
      ['Coach IA con voz (STT/TTS), 4 idiomas', '✓', '✗', '✗', '✗', '✗'],
      ['Crónicas IA automáticas (CMS)', '✓', '✗', '✗', '✗', '✗'],
      ['Multi-idioma nativo (ES/EN/FR/PT)', '✓', 'Parcial', 'Parcial', 'Parcial', 'Parcial'],
      ['Login con Google OAuth', '✓', '✓', '✓', '✓', 'Parcial'],
      ['Directorio de clubes / descubrimiento local', '✓', '✓', '✓', '✓', '✗'],
    ],
  ...
  en: {
    ...
    comparisonScore: '20 of 20 features',
    comparisonCols: ['Feature', 'PADELORGANIZERS', 'Playtomic', 'MATCHi', 'Padel Mates', 'Padel Manager'],
    comparison: [
      ['Online court booking', '✓', '✓', '✓', '✓', '✓'],
      ['Card payments (Stripe)', '✓', '✓', '✓', '✓', '✓'],
      ['PayPal payments (live)', '✓', 'Partial', 'Partial', '✓', 'Partial'],
      ['Split payment per player', '✓', '✓', 'Partial', '✓', '✗'],
      ['Matchmaking / find a player', '✓', '✓', '✓', '✓', '✗'],
      ['No-show protection + waitlist', '✓', 'Partial', '✓', '✗', '✗'],
      ['Tournament engine (Americano/Mexicano/Swiss/KO)', '✓', 'Partial', 'Partial', '✓', '✓'],
      ['Leagues with automatic ELO ranking', '✓', '✓', '✓', 'Partial', '✓'],
      ['Live scoring set by set', '✓', 'Partial', '✗', '✗', 'Partial'],
      ['Downloadable social card', '✓', 'Partial', '✗', '✗', '✗'],
      ['Yield management (dynamic pricing)', '✓', 'Partial', 'Partial', '✗', '✗'],
      ['IoT: QR lights + energy savings', '✓', '✗', '✓', '✗', '✗'],
      ['School ERP + recurring billing', '✓', '✓', '✓', '✗', '✗'],
      ['Player card + public profile', '✓', 'Partial', '✗', 'Partial', '✗'],
      ['Business dashboard (KPIs)', '✓', '✓', '✓', '✗', 'Partial'],
      ['AI Coach with voice (STT/TTS), 4 languages', '✓', '✗', '✗', '✗', '✗'],
      ['Automatic AI match reports (CMS)', '✓', '✗', '✗', '✗', '✗'],
      ['Native multi-language (ES/EN/FR/PT)', '✓', 'Partial', 'Partial', 'Partial', 'Partial'],
      ['Google OAuth login', '✓', '✓', '✓', '✓', 'Partial'],
      ['Club directory / local discovery', '✓', '✓', '✓', '✓', '✗'],
    ],
  ...
  fr: {
    ...
    comparisonScore: '20 fonctions sur 20',
    comparisonCols: ['Fonction', 'PADELORGANIZERS', 'Playtomic', 'MATCHi', 'Padel Mates', 'Padel Manager'],
    comparison: [
      ['Réservation en ligne de pistes', '✓', '✓', '✓', '✓', '✓'],
      ['Paiement par carte (Stripe)', '✓', '✓', '✓', '✓', '✓'],
      ['Paiement PayPal (live)', '✓', 'Partiel', 'Partiel', '✓', 'Partiel'],
      ['Paiement divisé par joueur (splits)', '✓', '✓', 'Partiel', '✓', '✗'],
      ['Matchmaking / trouver un partenaire', '✓', '✓', '✓', '✓', '✗'],
      ['Anti no-show + liste d\'attente', '✓', 'Partiel', '✓', '✗', '✗'],
      ['Moteur de tournois (Américain/Mexicain/Suisse/Élim.)', '✓', 'Partiel', 'Partiel', '✓', '✓'],
      ['Ligues avec classement ELO automatique', '✓', '✓', '✓', 'Partiel', '✓'],
      ['Score en direct set par set', '✓', 'Partiel', '✗', '✗', 'Partiel'],
      ['Carte sociale téléchargeable', '✓', 'Partiel', '✗', '✗', '✗'],
      ['Yield management (tarification dynamique)', '✓', 'Partiel', 'Partiel', '✗', '✗'],
      ['IoT: lumières QR + économies d\'énergie', '✓', '✗', '✓', '✗', '✗'],
      ['ERP école + facturation récurrente', '✓', '✓', '✓', '✗', '✗'],
      ['Carnet + fiche publique du joueur', '✓', 'Partiel', '✗', 'Partiel', '✗'],
      ['Tableau de bord (KPIs)', '✓', '✓', '✓', '✗', 'Partiel'],
      ['Coach IA à la voix (STT/TTS), 4 langues', '✓', '✗', '✗', '✗', '✗'],
      ['Cróniques IA automatiques (CMS)', '✓', '✗', '✗', '✗', '✗'],
      ['Multilingue natif (ES/EN/FR/PT)', '✓', 'Partiel', 'Partiel', 'Partiel', 'Partiel'],
      ['Connexion Google OAuth', '✓', '✓', '✓', '✓', 'Partiel'],
      ['Annuaire de clubs / découverte locale', '✓', '✓', '✓', '✓', '✗'],
    ],
  ...
  pt: {
    ...
    comparisonScore: '20 de 20 funções',
    comparisonCols: ['Função', 'PADELORGANIZERS', 'Playtomic', 'MATCHi', 'Padel Mates', 'Padel Manager'],
    comparison: [
      ['Reserva online de pistas', '✓', '✓', '✓', '✓', '✓'],
      ['Pagamento com cartão (Stripe)', '✓', '✓', '✓', '✓', '✓'],
      ['Pagamento PayPal (live)', '✓', 'Parcial', 'Parcial', '✓', 'Parcial'],
      ['Pagamento dividido por jogador (splits)', '✓', '✓', 'Parcial', '✓', '✗'],
      ['Matchmaking / encontrar quarto', '✓', '✓', '✓', '✓', '✗'],
      ['Anti no-show + lista de espera', '✓', 'Parcial', '✓', '✗', '✗'],
      ['Motor de torneios (Americano/Mexicano/Suíço/Elim.)', '✓', 'Parcial', 'Parcial', '✓', '✓'],
      ['Ligas com ranking ELO automático', '✓', '✓', '✓', 'Parcial', '✓'],
      ['Live scoring set a set', '✓', 'Parcial', '✗', '✗', 'Parcial'],
      ['Cartão social para download', '✓', 'Parcial', '✗', '✗', '✗'],
      ['Yield management (preços dinâmicos)', '✓', 'Parcial', 'Parcial', '✗', '✗'],
      ['IoT: luzes QR + poupança de energia', '✓', '✗', '✓', '✗', '✗'],
      ['ERP escola + cobrança recorrente', '✓', '✓', '✓', '✗', '✗'],
      ['Carnê + ficha pública do jogador', '✓', 'Parcial', '✗', 'Parcial', '✗'],
      ['Dashboard de negócio (KPIs)', '✓', '✓', '✓', '✗', 'Parcial'],
      ['Coach IA com voz (STT/TTS), 4 idiomas', '✓', '✗', '✗', '✗', '✗'],
      ['Crónicas IA automáticas (CMS)', '✓', '✗', '✗', '✗', '✗'],
      ['Multilíngue nativo (ES/EN/FR/PT)', '✓', 'Parcial', 'Parcial', 'Parcial', 'Parcial'],
      ['Login com Google OAuth', '✓', '✓', '✓', '✓', 'Parcial'],
      ['Diretório de clubes / descoberta local', '✓', '✓', '✓', '✓', '✗'],
    ],
    ...
    <div style={{ minHeight: '100vh', background: 'var(--padel-bg)', color: 'var(--padel-text)' }}>
      ...
      <section style={{ position: 'relative', padding: '28px 0 48px', minHeight: 'calc(100vh - 92px)', overflow: 'hidden' }}>
        ...
        <div style={{ ...sectionStyle, position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'var(--padel-muted)', marginTop: '10px', fontWeight: 600 }}>{T.ctaDemoSub}</p>
        </div>
      </section>
      ...
      <section style={{ padding: '70px 0', background: 'var(--padel-card-bg)', borderTop: '1px solid var(--padel-border)', borderBottom: '1px solid var(--padel-border)' }}>
        <div style={sectionStyle}>
          <h2 style={{ fontSize: '34px', fontWeight: 900, color: 'var(--padel-text)', textAlign: 'center', marginBottom: '36px' }}>
            {T.comparisonTitle}
            {T.comparisonScore && (
              <span style={{ display: 'inline-block', marginLeft: '14px', verticalAlign: 'middle', background: 'linear-gradient(135deg, var(--padel-emerald), var(--padel-lime))', color: '#fff', fontSize: '12px', fontWeight: 800, padding: '6px 14px', borderRadius: '20px' }}>
                🏆 {T.comparisonScore}
              </span>
            )}
          </h2>
