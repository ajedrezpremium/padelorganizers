...
| 5. Business | Payments + Sponsorship + Marketplace | 🟡 Stripe (reservas/splits/inscripciones/escuela) + panel RevPAC (`/panel`) + sponsors/banners/ROI (`/sponsors`). Falta marketplace |
